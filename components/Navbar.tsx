...
const navItems = [
  {
    ...
    icon: Layers,
    color: "text-sky-400",
    mobileColor: "group-hover:text-sky-400",
  },
  {
    name: "Posters",
    href: "#posters",
    ...
    mobileColor: "group-hover:text-violet-400",
  },
  {
    name: "About",
    href: "#about",
    ...
    mobileColor: "group-hover:text-emerald-400",
  },
  {
    name: "Contact",
    href: "#contact",
    icon: Mail,
    color: "text-rose-400",
    mobileColor: "group-hover:text-rose-400",
  },
];
            ...
            >
              ...
              <div className="relative flex items-center gap-2 z-10">
                ...
                >
                  <item.icon
                    size={16}
                    className={`${item.color} min-w-[16px]`}
                  />
                </motion.div>
      ...
      >
        <div className="flex flex-col items-start gap-8">
          {navItems.map((item, i) => (
            ...
            >
              <item.icon
                className={`w-6 h-6 text-zinc-600 ${item.mobileColor} transition-colors`}
              />
              {item.name}
            </motion.a>
          ))}
